...
PR = 20 # Rayon prévu des particules

# Les particules sont à l'interface entre les couches 1 et 2
particules = particules_matrice(PR, 4, 4, 100, 100, d2, n1)

onde_initiale = smuthi.initial_field.PlaneWave(vacuum_wavelength=450, polar_angle=4*np.pi/5, azimuthal_angle=0, polarization=0)
